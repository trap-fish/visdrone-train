...
# Paths
image_root_dir = "/media/citi-ai/matthew/visdrone-train/datasets/Okutama/test"
label_root_dir = "/media/citi-ai/matthew/visdrone-train/datasets/Okutama/test/Labels/SingleActionTrackingLabels/3840x2160"
...
output_image_dir = os.path.join(output_dir, "test/images")
...
for label_file in os.listdir(label_root_dir):
    ...
    print(f"Processed {label_file}: YOLO labels and images saved in {output_dir}")

print(f"YOLO dataset generated in:\Test Images: {output_image_dir}\nTest Labels: {output_label_dir}\n")
